...
class Api
{
     ...
     * @throws LocalizedException
     */
    public function disableTlsActivation($id)
    {
        $url = $this->config->getApiEndpoint() . 'tls/activations/' . $id;
        return $this->_fetch(
            $url,
     ...
     * @throws LocalizedException
     */
    public function enableTlsActivation($activation = [])
    {
        $url = $this->config->getApiEndpoint() . 'tls/activations';
        return $this->_fetch(
            $url,
