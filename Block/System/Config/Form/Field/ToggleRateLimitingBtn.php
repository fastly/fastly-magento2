...
class ToggleRateLimitingBtn extends Field
{
    protected function _construct() // @codingStandardsIgnoreLine - required by parent class
    {
        $this->_template = 'Fastly_Cdn::system/config/form/field/toggleRateLimitingBtn.phtml';
    ...
    public function getButtonHtml()
    {
        $button = $this->getLayout()->createBlock(
            ...
            [
                'id' => 'fastly_toggle_rate_limiting_btn',
