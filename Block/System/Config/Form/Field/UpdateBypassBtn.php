...
class UpdateBypassBtn extends Field
{
    ...
    public function getButtonHtml()
    {
        $button = $this->getLayout()->createBlock(
            ...
            'id'    => 'fastly_update_bypass_button',
            'label' => __('Update WAF Bypass Config')
        ]);
