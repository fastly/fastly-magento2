 ...
 */
class ModlyActiveModules extends AbstractFieldArray
{
    /**
     * @var Factory
     */
    ...
    {
        $this->addColumn('module_name', ['label' => __('Name')]);
        $this->_addAfter = false;
        $this->_template = 'Fastly_Cdn::system/config/form/field/modlyActiveModules.phtml';
