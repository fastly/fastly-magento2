...
/**
 * Class CreateLogEndpointBtn
 * @package Fastly\Cdn\Block\System\Config\Form\Field
 */
class CreateLogEndpointBtn extends Field
{
    protected function _construct() // @codingStandardsIgnoreLine - required by parent class
    {
        $this->_template = 'Fastly_Cdn::system/config/form/field/createLogEndpointBtn.phtml';
    ...
    public function getButtonHtml()
    {
        $button = $this->getLayout()->createBlock(
            ...
            'id'    => 'fastly_create_log_endpoint_button',
            'label' => __('Create')
        ]);
