define([
    ...
    return function (config, serviceStatus, isAlreadyConfigured) {
        ...
        function toggleSu(active_version)
        {
            let activate_su_flag = false;

            if ($('#fastly_activate_su').is(':checked')) {
                activate_su_flag = true;
            }
            ...
            $.ajax({
                ...
                data: {
                    'activate_flag': activate_su_flag,
